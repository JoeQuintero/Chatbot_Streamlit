...
# nltk es un conjunto de bibliotecas para el procesamiento de lenguaje natural
# keras es una biblioteca/API de Redes Neuronales de Código abierto escrita en Python.
...
#Recorre cada intento y sus patrones en el archivo JSON
